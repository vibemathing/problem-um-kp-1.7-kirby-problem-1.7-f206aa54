...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.7-kirby-problem-1.7-f206aa54-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.7"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.7-kirby-problem-1.7-f206aa54-v1",
      "problem_contract_sha256": "6067ebe2136571e4db427bd8529aa376ac63498fc033024b3e129068b35cb7b5",
      "problem_id": "problem:um-kp-1.7-kirby-problem-1.7-f206aa54",
      "route_id": "route:um-kp-1.7-kirby-problem-1.7-f206aa54-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.7-kirby-problem-1.7-f206aa54-source-fidelity-01",
      "graph_id": "graph:um-kp-1.7-kirby-problem-1.7-f206aa54-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.7-kirby-problem-1.7-f206aa54-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.7-kirby-problem-1.7-f206aa54-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Show that the sequence of absolute values of the coefficients of the Alexander polynomial of a link are: (a) concave $($ Fox’s trapezoidal conjecture $)$, or (b) for an alternating link, log concave $($ Stoimenow’s strong Fox conjecture $)$. (c) For a positive link, is the sequence of the coefficients of the Conway poly- nomial strongly log concave?"
          },
          "statement_sha256": "fabf969ad25d043cfd058a1b61592a3bef1427b4fefabfe3f9b1dc04e33888cd"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.7-kirby-problem-1.7-f206aa54-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.7-kirby-problem-1.7-f206aa54-root",
      "route_id": "route:um-kp-1.7-kirby-problem-1.7-f206aa54-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.7-debafaf7e5ca",
        "url": "https://www.unsolvedmath.com/problems/KP-1.7"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
